            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                    <div style={{
                        ...
                        <LogIn style={{ color: '#6366f1' }} size={28} />
                    </div>
                    <h1 style={{ color: 'white', fontSize: '24px', fontWeight: 800, margin: '0 0 8px' }}>Login</h1>
                    <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '14px', margin: 0 }}>Welcome back! Log in to your account.</p>
                </div>
                ...
                <p style={{ textAlign: 'center', marginTop: '32px', color: 'rgba(255,255,255,0.5)', fontSize: '14px' }}>
                    Don't have an account? <Link to="/job-hunt/register" style={{ color: '#818cf8', fontWeight: 600, textDecoration: 'none' }}>Register</Link>
                </p>
            </div>
